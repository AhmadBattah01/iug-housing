        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">ملفي الشخصي</h4>
                </div>
                ...
                <div class="row">
                    ...
                    $aid=$_SESSION['id'];
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">آخر تحديث في</h4>
...
<!-- By CodeAstro - codeastro.com -->
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">رقم الطالب</h4>
                                        <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">اسم الجد</h4>
                                        <div class="form-group">
