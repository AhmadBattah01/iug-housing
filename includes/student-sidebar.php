...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span
         class="hide-menu">الرئيسية</span></a></li>

        <li class="list-divider"></li>

        <li class="nav-small-cap"><span class="hide-menu">القوائم</span></li>
        ...
        class="hide-menu">تفاصيل غرفتك</span></a></li>
        ...
        class="hide-menu">انشطة تسجل الدخول</span></a></li>

        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="profile.php"><i data-feather="user"
         class="svg-icon mr-2 ml-1"></i> الملف الشخصي</a></li>
