<?php
 ...
 //   $query_2="INSERT into  registration(regno,firstName,middleName,lastName,gender,contactno,emailid) values(?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
  //  $stmt_2 = $mysqli->prepare($query_2);
    $rc=$stmt->bind_param('sssssiss',$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$password);
 //   $rc=$stmt_2->bind_param('sssssis',$regno,$fname,$mname,$lname,$gender,$contactno,$emailid);
    $stmt->execute();
                ...
                <form method="POST" name="registration" onSubmit="return valid();">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">الاسم الاخير</h4>
                                        <div class="form-group">
                                            <input type="text" name="lname" id="lname" placeholder="الاسم الاخير" required class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
