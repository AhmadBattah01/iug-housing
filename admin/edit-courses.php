...
<head>
    ...
    <title>تحرير المراحل الدراسية</title>
    <!-- Custom CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">تعديل المرحلة الدراسية</h4>
                ...
                <form method="POST">
                    ...
                    <?php	
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">مدة المرحلة الدراسية</h4>
                                        <div class="form-group">
